...
Seed.create(view_counter: 0, url: "https://www.youtube.com/watch?v=qu5PxhEUMfU" , secondary_url: "https://www.youtube.com/watch?v=Af_vBiTmydY", title: "Le tube d'Hendaye", expiration: DateTime.now.utc + 3.days, user_id: thomas.id, category_id: sport.id, description: "Perso Ma Men, c'est les plus grosses vagues que j'ai ridé", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg"])
Seed.create(view_counter: 0, url: "https://www.youtube.com/watch?v=qu5PxhEUMfU" , secondary_url: "https://www.youtube.com/watch?v=Af_vBiTmydY", title: "La balle fusion", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: sport.id, description: "Ca file au vent, pénétration idéale", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg"])
Seed.create(view_counter: 0, url: "https://www.youtube.com/watch?v=qu5PxhEUMfU" , secondary_url: "https://www.youtube.com/watch?v=Af_vBiTmydY", title: "L'oeuvre d'art des artistes", expiration: DateTime.now.utc + 4.days, user_id: renan.id, category_id: sorties.id, description: "J'aime bien les chiens, regardez ma photo de profil, et ça c'est un super chien", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504619657/wmjrhxdqczonc6jbz9g0.jpg"])
