...
seed_maison = Seed.create(price: 300, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=KNuUGEahHg8" , secondary_url: "", title: "L'oeuvre d'art des artistes", expiration: DateTime.now.utc + 4.days, user_id: onur.id, category_id: maison.id, description: "Franchement, je paye direct, c'est top", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504619657/wmjrhxdqczonc6jbz9g0.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
