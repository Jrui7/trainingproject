...
seed_mode = Seed.create(status: "published", price: 150,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", size_guide: "https://www.monsieurtshirt.com/informations/8-guide-des-tailles", popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=5AhY_-qUb4w" , title: "T-shirt Psycha", expiration: DateTime.now.utc + 3.days, user_id: thomas.id, category_id: mode.id, description: "Avec ça Men, tu peux même parler boulot après 19h00", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509956287/hdecr3jxijppwsukhi0l.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1509623265/ridfuoa67vz6ewlb3zop.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_sport  = Seed.create(status: "published", expedition_costs: 4.9, price: 100,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=5AhY_-qUb4w" , title: "Le tube d'Hendaye", expiration: DateTime.now.utc + 3.days, user_id: thomas.id, category_id: sport.id, description: "Perso Ma Men, c'est les plus grosses vagues que j'ai ridé", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg"])
seed_tech = Seed.create(status: "published", expedition_costs: 7.9, price: 250,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "Pour être beau comme un prince", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: tech.id, description: "C'est l'astuce pour transformer n'importe qui en super-model", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509787225/upljdsxonu1c9skxuemd.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_loisir = Seed.create(status: "published", expedition_costs: 20.5, price: 200,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "La balle fusion", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: loisir.id, description: "Ca file au vent, pénétration idéale", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_maison = Seed.create(status: "published", expedition_costs: 3.9, price: 300,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=KNuUGEahHg8" , title: "L'oeuvre d'art des artistes", expiration: DateTime.now.utc + 4.days, user_id: onur.id, category_id: maison.id, description: "Franchement, je paye direct, c'est top", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504619657/wmjrhxdqczonc6jbz9g0.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_enfants = Seed.create(status: "published", expedition_costs: 5.9, price: 350,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=VHYUjNh0T1w" , title: "Meilleure table vegan de Los Angeles", expiration: DateTime.now.utc + 4.days, user_id: onur.id, category_id:enfants.id, description: "Avec des plats comme ceux-ci, plus d'excuse pour ne pas tenter de changer son alimentation", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509986837/vegan_xiomv3.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_animaux = Seed.create(status: "published", expedition_costs: 2.9, price: 400,sale_point_url:"https://medium.com/", official_description: "Produit polyvalent qui permet plein de choses que l'on ne peut imaginer à première vue", url: "https://www.youtube.com/watch?v=VHYUjNh0T1w" , title: "Test si ça marche", expiration: DateTime.now.utc + 1.minutes, user_id: onur.id, category_id: animaux.id, description: "Avec des plats comme ceux-ci, plus d'excuse pour ne pas tenter de changer son alimentation", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509986837/vegan_xiomv3.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
