...
seed_loisir = Seed.create(popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "La balle fusion", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: loisir.id, description: "Ca file au vent, pénétration idéale", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg"])
seed_beauté = Seed.create(popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "Pour être beau comme un prince", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: beauté.id, description: "C'est l'astuce pour transformer n'importe qui en super-model", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509787225/upljdsxonu1c9skxuemd.jpg"])
seed_art = Seed.create(popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=KNuUGEahHg8" , title: "L'oeuvre d'art des artistes", expiration: DateTime.now.utc + 4.days, user_id: renan.id, category_id: art.id, description: "J'aime bien les chiens, regardez ma photo de profil, et ça c'est un super chien", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504619657/wmjrhxdqczonc6jbz9g0.jpg"])
