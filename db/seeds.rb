...
seed_tech = Seed.create(price: 250, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "Pour être beau comme un prince", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: tech.id, description: "C'est l'astuce pour transformer n'importe qui en super-model", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509787225/upljdsxonu1c9skxuemd.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_loisir = Seed.create(price: 200, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=XkA6UAfmJjc" , title: "La balle fusion", expiration: DateTime.now.utc + 2.days, user_id: jorge.id, category_id: loisir.id, description: "Ca file au vent, pénétration idéale", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504544452/yxdwojuuq0q71p2oemmz.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_maison = Seed.create(price: 300, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=KNuUGEahHg8" , title: "L'oeuvre d'art des artistes", expiration: DateTime.now.utc + 4.days, user_id: onur.id, category_id: maison.id, description: "Franchement, je paye direct, c'est top", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1504619657/wmjrhxdqczonc6jbz9g0.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_enfants = Seed.create(price: 350, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=VHYUjNh0T1w" , title: "Meilleure table vegan de Los Angeles", expiration: DateTime.now.utc + 4.days, user_id: onur.id, category_id:enfants.id, description: "Avec des plats comme ceux-ci, plus d'excuse pour ne pas tenter de changer son alimentation", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509986837/vegan_xiomv3.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
seed_animaux = Seed.create(price: 400, popularity: 0, view_counter: 0, url: "https://www.youtube.com/watch?v=VHYUjNh0T1w" , title: "Test si ça marche", expiration: DateTime.now.utc + 1.minutes, user_id: onur.id, category_id: animaux.id, description: "Avec des plats comme ceux-ci, plus d'excuse pour ne pas tenter de changer son alimentation", photo_urls: ["http://res.cloudinary.com/dlddnk3pr/image/upload/v1509986837/vegan_xiomv3.jpg", "http://res.cloudinary.com/dlddnk3pr/image/upload/v1505138572/eecindhnvh2ltpxpitb9.jpg"])
